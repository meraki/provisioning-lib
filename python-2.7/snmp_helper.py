# Courtesy Kirk Byers - https://github.com/ktbyers/pynet/blob/master/snmp/snmp_helper.py
# minor module additions for get_mx_cellular_status.py
# 10/2016
...
def snmp_extract2(snmp_data):
    ...
    if len(snmp_data) == 0:
        ...
        # Unwrap the data which is returned as a tuple wrapped in a list
        return snmp_data[0][0].prettyPrint()